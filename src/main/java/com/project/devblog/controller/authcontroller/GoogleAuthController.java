...
//        SecurityContextHolder.getContext().setAuthentication(authentication);
        httpServletResponse.addHeader(AUTH_HEADER_KEY,
//                TOKEN_PREFIX + ((DefaultOidcUser) authentication.getPrincipal()).getIdToken().getTokenValue()
                TOKEN_PREFIX + jwtTokenUtil.createToken(userEntity.getLogin(), Role.USER));

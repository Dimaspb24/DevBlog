...
public interface CommentRepository extends JpaRepository<CommentEntity, Long> {
    Page<CommentEntity> findAllByArticleIdAndEnabledIsTrue(@NonNull Integer articleId, Pageable pageable);

    Page<CommentEntity> findAllByAuthorIdAndArticleIdAndEnabledIsTrue(@NonNull String authorId, @NonNull Integer articleId, Pageable pageable);
